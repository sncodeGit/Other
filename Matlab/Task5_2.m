...
function [] = main()
    ...
    % y(0) = 0
    % z(0) = 2
    % P.S. Не совсем понимаю по формулировке условия, сохраняется ли для этой системы условие 
    ...
    % вдоль оси Oy (вплоть до тривиального случая y'(0) = 0, когда графики 
    % представляют из себя прямые).
    ...
    % Как видно, в этой системе присутствует постепенное затухание 
